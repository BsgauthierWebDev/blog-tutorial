...
const CommentsForm = ({slug}) => {
    ...
    return (
        <div className = 'bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            <h3 className = 'text-xl mb-8 font-semibold border-b pb-4'>Leave a Message</h3>
            ...
            <div className = 'grid grid-cols-1 gap-4 mb-4'>
                <div>
                    ...
                    <label className = 'text-gray-500 cursor-pointer ml-2' htmlFor = 'storeData'>Save my info for next time.</label>
                </div>    
            </div>
